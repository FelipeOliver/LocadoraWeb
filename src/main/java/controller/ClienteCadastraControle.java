...
@WebServlet("/addClie.do")
public class ClienteCadastraControle extends HttpServlet {
   private static final long serialVersionUID = 1L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      try{
    	  String status = clienteDAO.cadastraCliente(cliente);
          request.setAttribute("erro",status);
          request.getRequestDispatcher("erro_login.jsp");
      }catch (Exception e){
